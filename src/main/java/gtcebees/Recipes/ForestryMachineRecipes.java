...
public class ForestryMachineRecipes {
    public static void init() {
        ...
        if (Materials.Oil.getMaterialFluid() != null)
            RecipeManagers.squeezerManager.addRecipe(20, GTCombItem.getComb(GTCombs.OIL, 1), Objects.requireNonNull(Materials.Oil.getFluid(150)), ModuleCore.getItems().beeswax.getItemStack(), 30);
